...
int main()
{
    ...
    std::string src_image_file_path("C:\\Users\\TJR\\Desktop\\cpp-game-engine\\res\\image\\input.jpg");
    std::string cpt_file_path("C:\\Users\\TJR\\Desktop\\cpp-game-engine\\res\\image\\input_compressed.cpt");
