...
Texture2D::Texture2D_ptr Texture2D::LoadFromFile(std::string &image_file_path) {
    Texture2D_ptr texture2d = std::make_shared<Texture2D>();
//    StopWatch stopwatch;
//    stopwatch.start();
    //读取 cpt 压缩纹理文件
    ...
    {
        std::cerr<<"failed open "<<image_file_path<<std::endl;
    }
